...
Hello, thank you for using Ad-block Filter Counter! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-adblock-filter-counter/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-adblock-filter-counter/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-adblock-filter-counter/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Ad-block Filter Counter version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-adblock-filter-counter/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-adblock-filter-counter/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Ad-block Filter Counter:
...
<div align="center">
  Thank you for using Ad-block Filter Counter!
  <br>
